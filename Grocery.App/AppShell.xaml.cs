...
namespace Grocery.App
{
    public partial class AppShell : Shell
    {
        public AppShell()
        {
            ...
            // Registers the NewProductView page so the app can navigate to it by name.
            // Needed so the app knows how to navigate to this page by its name using Shell routing.
